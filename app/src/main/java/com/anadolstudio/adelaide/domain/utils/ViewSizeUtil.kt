...
object ViewSizeUtil {
    ...
    private fun getSupportPair(
        ...
        val ratio: Float = com.anadolstudio.photoeditorcore.domain.util.BitmapCommonUtil.getScaleRatioMax(
                widthInto,
                heightInto,
                widthOut,
                heightOut
    ...
    fun fitViewToEdge(
        ...
        val ratio = min(
                com.anadolstudio.photoeditorcore.domain.util.BitmapCommonUtil.getScaleRatio(
